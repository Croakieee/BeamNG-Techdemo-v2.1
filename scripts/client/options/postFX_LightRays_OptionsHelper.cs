...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function Settings_PostFX_LightRays_General_enabled_getValue()
{    
    return LightRayPostFX.isEnabled();
}
function Settings_PostFX_LightRays_General_enabled_setValue( %value )
{
    if( %value $= "true" )
        %value = true;
    else if( %value $= "false")
    ...
    $PostFXManager::PostFX::EnableLightRay = %value;
