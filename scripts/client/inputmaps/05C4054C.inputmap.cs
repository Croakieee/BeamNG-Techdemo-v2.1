// Product Name: Dualshock 4 Playstation Controller (Wireless Controller) - wired
...
//Zooming in and out
%mm.bind(%device, button2, "gamepadZoom(0.1);", "gamepadZoom(0);");
%mm.bind(%device, button3, "gamepadZoom(-0.1);", "gamepadZoom(0);");
